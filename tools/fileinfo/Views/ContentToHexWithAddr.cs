...
{
    internal static class ContentToHexWithAddr
    {
        internal static string ByteArrayToHex(byte[] content, ushort? addr, Func<byte, bool, char> encoding)
        {
        ...
        {
            return ByteArrayToHex(detail.Content, detail!.Address, encoding);
        }
    }
}
