...
// 	uint8_t state = 6;             // default state save and decrement
...
// 	retdata = _rx_buffer[index];
// 	if ((retdata & 0xA000) == 0xA000) return (uint16_t)PS2_KEY_IGNORE;
// 	return retdata;
// }
...
// void PS2KeyAdvanced::resetKey(void) {
...
// uint8_t PS2KeyAdvanced::available(void) {
// 	int8_t  i, idx;
// 	uint16_t data;
...
// uint16_t PS2KeyAdvanced::read(void) {
// 	uint16_t result;
// 	uint8_t idx;
